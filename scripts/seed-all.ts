/**
 * Seed the data needed to run the portfolio website.
 *
...
async function seedWorkExperiences(
  ...
  const rows: NewWorkExperience[] = [
    ...
    {
      id: "menora-senior-customer-service",
      ...
      description:
        "Additional experience managing day-to-day operations for a 17-person service team and supporting service-quality improvement through structured processes.",
      achievements: [
        "Managed day-to-day operations for a 17-person service team.",
        "Oversaw 5 collections representatives.",
        "Trained team members and supported service-quality improvement through structured processes.",
      ],
      technologies: ["Service operations", "Team training", "Structured processes"],
      responsibilities: [
        "Team operations",
        "Collections representative oversight",
        "Training",
...
async function seedPublicContentBlocks(
  ...
  const rows: NewPublicContentBlock[] = [
    ...
    },
    {
      ...
      subtitle: "Full-Stack TypeScript Engineer",
      body:
    ...
    },
    {
      ...
      body:
        "Volunteer technical leadership role. I serve as the primary hands-on engineer for public-facing and internal systems, content workflows, tooling, integrations, CI/CD, analytics foundations, and production readiness.",
      displayOrder: 32,
      isVisible: true,
      isFeatured: true,
      createdBy,
  ...
  const rows: NewProject[] = [
    {
      ...
      description:
        "This exact Portfolio repository: a production Next.js portfolio platform with clean URLs, authenticated admin tooling, content APIs, and recruiter-facing proof surfaces.",
      longDescription:
        "This exact repository powers the public portfolio site and its private content/career-data workflows, built to make resume, project, and implementation proof easier to maintain.",
    ...
    },
    {
      ...
      caseStudyRole:
        "End-to-end technical lead across product architecture, implementation direction, and release readiness.",
      proofLinks: [],
      privateRepoNote:
    ...
    },
    {
      ...
      isOpenSource: false,
      isResumeFeatured: true,
      caseStudySlug: "clipwhisperer",
      hiringSignal:
        "Queue-driven media automation system showing backend orchestration, processing boundaries, storage, and delivery workflows.",
      constraints: [
    ...
    },
    {
      ...
      isOpenSource: false,
      isResumeFeatured: true,
      caseStudySlug: "snow-hq",
      hiringSignal:
        "Multi-tenant CRM work showing tenant-aware data modeling, RBAC, dashboard workflows, and type-safe full-stack delivery.",
      constraints: [
