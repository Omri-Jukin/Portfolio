...
const proficiencyOptions = [
  ...
  { value: "intermediate", label: "Intermediate", range: [26, 50] },
  { value: "advanced", label: "Advanced", range: [51, 75] },
  { value: "expert", label: "Expert", range: [76, 100] },
];
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2, mt: 1 }}>
            ...
            <Box sx={{ display: "flex", gap: 2 }}>
              ...
              <TextField
                ...
                onChange={(e) =>
                  setFormData((prev) => ({ ...prev, lastUsed: e.target.value }))
                }
              ...
              (field) => (
                <Box key={field}>
                  ...
                  <Box sx={{ display: "flex", gap: 1, mb: 1 }}>
                    <TextField
                      label={`Add ${
                        field === "relatedSkills" ? "skill" : field.slice(0, -1)
                      }`}
