/**
 * Custom Link Intake Form Component
 * 
  ...
  return (
    <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto" }}>
      ...
      <div style={{ 
        ...
        <p>
          This custom intake form is currently disabled while we migrate to a 
          Cloudflare-compatible email service.
        </p>
        <p>
          Please contact me directly via email: <a href="mailto:omrijukin@gmail.com">omrijukin@gmail.com</a>
        </p>
      </div>
    </div>
  );
