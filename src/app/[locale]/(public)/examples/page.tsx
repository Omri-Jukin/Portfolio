...
const PathSelection3D = dynamic(
  () =>
    import("#/Components/HeavyComponents").then((mod) => ({
      default: mod.PathSelection3D,
    })),
  { ssr: false }
);
// PathSelection3DCard removed due to scaling issues
        ...
        <TabPanel value={tabValue} index={0}>
          ...
          >
            ...
            <SectionCard sx={{ gridColumn: { xs: "1", md: "1 / -1" } }}>
              <CardContent>
                <Typography variant="h6" gutterBottom>
                  3D Path Selection Cards
                </Typography>
                <Typography variant="body2" color="text.secondary" paragraph>
                  Interactive 3D floating cards with orbit controls. Drag to
                  orbit, scroll to zoom, click to select. Demonstrates Three.js
                  integration with React Three Fiber.
                </Typography>

                <DemoContainer sx={{ minHeight: 600 }}>
                  <PathSelection3D
                    height={600}
                    onSelect={(type) => {
                      ...
                      // - "browse" → navigate to portfolio/projects page
                    }}
                  />
                </DemoContainer>
              </CardContent>
