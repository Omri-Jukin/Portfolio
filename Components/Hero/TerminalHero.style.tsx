...
export const TerminalWindow = styled(Box)`
  width: 100%;
  max-width: 1200px;
  height: calc(100vh - 8rem); /* Account for padding and footer space */
  background: #0d1117;
  border-radius: 12px;
...
export const TerminalLine = styled(Box)`
...
export const TerminalInput = styled(TextField)`
  ...
  .MuiInputBase-input {
    ...
    border: none;
    outline: none;
    padding: 8px 12px; /* Add padding to push text inward from curved border */
  }
  ...
  .MuiInputBase-root {
    ...
    border: none;
    box-shadow: none;
    border-radius: 8px; /* Match the curved border */
  }
